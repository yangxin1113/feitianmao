 ...
 */
public class exActivity extends BaseFragmentActivity {
    ...
    private void setImgText(int index) {
        for (int i = 0; i < viewList.size(); i++) {
            ...
            if (i == index) {
                ...
                ((TextView) item.get("textView")).setTextColor(ContextCompat.getColor(exActivity.this, R.color.text_bottom_true));
            } else {
                ((ImageView) item.get("imageView")).setImageResource((int)item.get("img_false"));
                ((TextView) item.get("textView")).setTextColor(ContextCompat.getColor(exActivity.this, R.color.text_bottom_false));
            }
        }
    }
        ...
        OkHttpUtils.post()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int i) {
                        LSUtils.showToast(exActivity.this, "请求错误");
                    }
